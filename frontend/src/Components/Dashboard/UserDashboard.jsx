...
export default function UserDashboard() {
  ...
  const recentTransactions = [
    { id: 1, type: "Investment", amount: 500, date: "2024-12-15", status: "Active" },
    ...
    { id: 4, type: "Investment", amount: 300, date: "2024-12-12", status: "Active" }
  ];
  ...
  const investments = [
    ...
    { id: 3, name: "Stock Portfolio", amount: 500, return: 12.8, status: "Active" }
  ];
